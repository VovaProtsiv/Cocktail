...
class DetailsActivity() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.alcoholicDetails).apply {
            text = sharedBookingObject?.strAlcoholic
        }
        ...
        findViewById<TextView>(R.id.instructions).apply {
            text = sharedBookingObject?.strInstructions
        }
        ...
        val rawQuery = writableDatabase.rawQuery(
            "SELECT * FROM $TABLE_DRINKS WHERE $KEY_ID = '" + sharedBookingObject?.idDrink.toString() + "'",
            null
        )
        val id = sharedBookingObject?.idDrink.toString()
        var idFromDb: String? = null
        Log.d("-id ", sharedBookingObject?.idDrink.toString())
